...
const Onboarding: React.FC = () => {
  ...
  return (
    <section className="text-center bg-black py-10 sm:py-14 relative" ref={ref}>
      <h2 className={`text-2xl sm:text-3xl font-black tracking-tighter uppercase mb-8 sm:mb-12 text-white relative reveal-fade-up ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {[
            ...
            <div key={i} className={`bg-black p-6 sm:p-8 rounded-2xl relative group transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_12px_30px_-18px_rgba(0,0,0,0.8)] reveal-fade-up reveal-stagger-${i + 1} ${isVisible ? 'visible' : ''}`}>
              ...
              />
              <div className="text-4xl sm:text-5xl font-black text-pickwin-green mb-4" style={{ textShadow: '0 0 25px rgba(19,212,130,0.9)' }}>
              {item.step}
            </div>
      ...
      <div className={`flex flex-col items-center reveal-fade-up reveal-stagger-4 ${isVisible ? 'visible' : ''}`}>
